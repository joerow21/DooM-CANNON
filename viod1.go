...
func setAdvancedHeaders(req *http.Request){
        req.Header.Set("X-Forwarded-For", buildblock(2)+"."+buildblock(2)+"."+buildblock(2)+"."+buildblock(2))
        req.Header.Set("X-Real-IP", buildblock(2)+"."+buildblock(2)+"."+buildblock(2)+"."+buildblock(2))
}
